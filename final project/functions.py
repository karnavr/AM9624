...
# TO-DO 
# * look over current code and make sure I understand it 
# * simplify in any way possible, add comments, clean up in general 

# properly evalulate performance (numerically) 
# compare/plot with exact solution 

# PLOTTING 
# * plot the space-time solution (option for collocation points)
# * plot the loss function 
# * plot the profiles at different times 
